      ...
      <div className="container">
        <div className={styles.footer__content}>
          <a href="/" >
            ...
            <span className={styles.footer__logo}><span>L</span><span>O</span><span>C</span><span>A</span><span>L</span> <span>G</span><span>O</span>VERNMENT</span>
          </a>
          <address>
            ...
            <li className={styles.social_links__item}>
              <a href="/" className={styles.social_links__link}>
                <svg className={styles.social_links__icon}>
                  <use href="/icons.svg#icon-instagram" width="20px" height="20px"></use>
                </svg>
              </a>
            </li>
            <li className={styles.social_links__item}>
              <a href="/" className={styles.social_links__link}>
                <svg className={styles.social_links__icon}>
                  <use href="/icons.svg#icon-twitter" width="20px" height="20px"></use>
                </svg>
              </a>
            </li>
            <li className={styles.social_links__item}>
              <a href="/" className={styles.social_links__link}>
                <svg className={styles.social_links__icon}>
                  <use href="/icons.svg#icon-facebook" width="20px" height="20px"></use>
                </svg>
              </a>
            </li>
            <li className={styles.social_links__item}>
              <a href="/" className={styles.social_links__link}>
                <svg className={styles.social_links__icon}>
                  <use href="/icons.svg#icon-linkedin" width="20px" height="20px"></use>
                </svg>
              </a>
            </li>
          </ul>
